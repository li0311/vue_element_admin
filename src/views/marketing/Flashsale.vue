    ...
    <el-card class="box-card" shadow="never">
      ...
      <div class="table-container">
        <el-table
          ...
          <el-table-column
                  prop="groupList.s_num"
                  align="center"
                  label="限制人数"
                  width="100">
                  <template slot-scope="scope">{{scope.row.s_num}}</template>
          </el-table-column>
          <el-table-column
...
// 接口
import { fetchFlashsale, updateGroup, createGroup } from '@/api/marketing.js'
...
export default {
  ...
  methods: {
    ...
    _getGroupList(page, limit) {
      fetchFlashsale({page: page, limit: limit}).then(res => {
        console.log(res);
